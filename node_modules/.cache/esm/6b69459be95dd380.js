let tests,eq,binaryToDecimal,updateBitValue,getByteValue;_e95‍.w("./simpleTestNode",[["tests",["tests"],function(v){tests=v}],["eq",["eq"],function(v){eq=v}]]);_e95‍.w("../src/binaryToDecimal",[["binaryToDecimal",["binaryToDecimal"],function(v){binaryToDecimal=v}]]);_e95‍.w("../src/byteSectionFunctions",[["updateBitValue",["updateBitValue"],function(v){updateBitValue=v}],["getByteValue",["getByteValue"],function(v){getByteValue=v}]]);// Import functions
