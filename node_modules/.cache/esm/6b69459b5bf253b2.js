let tests,eq,binaryToDecimal,updateBitValue,getByteValue;_5bf‍.w("./simpleTestNode",[["tests",["tests"],function(v){tests=v}],["eq",["eq"],function(v){eq=v}]]);_5bf‍.w("../src/binaryToDecimal",[["binaryToDecimal",["binaryToDecimal"],function(v){binaryToDecimal=v}]]);_5bf‍.w("../src/byteSectionFunctions",[["updateBitValue",["updateBitValue"],function(v){updateBitValue=v}],["getByteValue",["getByteValue"],function(v){getByteValue=v}]]);// Import functions
...
tests({
  "it should receive a number and return a string": function() {
    ...
    eq(typeof transformedNumber, "stxring");
  },
